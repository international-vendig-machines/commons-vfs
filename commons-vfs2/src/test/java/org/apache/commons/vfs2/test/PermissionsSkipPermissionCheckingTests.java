 ...
 * @since 2.1
 */
public class PermissionsSkipPermissionCheckingTests extends AbstractProviderTestCase {
     ...
     */
    public void testExecutableSkipPermissionChecking() throws Exception {
     ...
     */
    public void testWriteableSkipPermissionChecking() throws Exception {
        final FileObject file = createTestFile();
     ...
     */
    public void testReadableSkipPermissionChecking() throws Exception {
        final FileObject file = createTestFile();
